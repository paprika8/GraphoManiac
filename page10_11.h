...
namespace Graphs
{
	...
	void create_p10_11() {
		...
		comp1->size = Size_(pointUI(100 * 10, percent), pointUI(80 * 10, percent)); //90
		...
		comp2->size = Size_(pointUI(100 * 10, percent), pointUI(20 * 10, percent)); //10
		...
		check_but1->text_size = 26 * check_but1->size.height * 0.002;
		...
		check_but2->text_size = 26 * check_but2->size.height * 0.002;
